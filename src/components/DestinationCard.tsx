      ...
      <div className="relative h-40 sm:h-48 overflow-hidden">
        ...
        {highlight && (
          <div className="absolute top-2 left-2">
            <div className="bg-secondary text-primary px-2 py-1 rounded-full text-xs sm:text-sm font-medium">
              Destaque
            </div>
          </div>
        )}
          ...
          <div className="absolute top-2 right-2">
            {title === "Orlando" ? (
              <img 
                ...
                alt="Mickey Mouse"
                className="w-8 h-8 sm:w-12 sm:h-12 object-contain mix-blend-multiply"
              />
            ) : title === "Paris" ? (
              <img 
